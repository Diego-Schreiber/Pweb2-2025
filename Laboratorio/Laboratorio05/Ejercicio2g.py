...
# Funciones para aplicar color
blanco = lambda p: p
negro = lambda p: p.negative()

# Filas de piezas (orden de ajedrez)
fila_piezas_blancas = [
...
# Función para alternar cuadros: blanco, negro, ...
...
# Generar una fila combinando piezas con casillas
...
# Convertir listas a Picture con join
def unir_fila(fila):
